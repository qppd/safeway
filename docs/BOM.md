...
- Note: Listing is **New Arrival** (no product ratings yet) — qualified via seller track record. Same seller sells the KY-008-compatible tube receiver.
...
- Warning: Avoid listings whose base price (~₱141) is for the "FT232 burner" variant only — misleading. Genuine ESP32-CAM boards run ₱500+ on Lazada PH.
